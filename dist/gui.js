...
window.utils = __webpack_require__(7);

window.modal_count = 0;
// dialog
...
gDialog.prototype = {
	init: function init() {
		this.$.dialog = $('<div class="g-dialog ' + this.opts.addClass + '">' + this.node.closeBtn + this.node.header + '<div class="content">' + this.opts.content + '</div>' + this.node.footer + '</div>');
		this.$.dialog.css({
...
window.gLoading = function (options) {
	...
	var loaderHtml = '<div class="loader">' + '<div class="loader-inner ball-pulse">' + '<div></div>' + '<div></div>' + '<div></div>' + '</div>' + '<div class="g-loading-text">正在拼命加载...</div>' + '</div>';
	this.opts_2 = {
